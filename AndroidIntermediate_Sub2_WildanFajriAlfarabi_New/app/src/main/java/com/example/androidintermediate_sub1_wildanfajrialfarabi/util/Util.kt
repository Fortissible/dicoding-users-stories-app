package com.example.androidintermediate_sub1_wildanfajrialfarabi.util
...
fun bitmapToFile(fileTemp: File, res: Bitmap): File {
    val byteArrayOutputStream = ByteArrayOutputStream()
    res.compress(Bitmap.CompressFormat.JPEG, 100, byteArrayOutputStream)
